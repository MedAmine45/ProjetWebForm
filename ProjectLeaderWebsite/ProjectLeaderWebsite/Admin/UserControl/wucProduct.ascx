<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucProduct.ascx.cs" Inherits="ProjectLeaderWebsite.Admin.UserControl.wucProduct" %>
<style type="text/css">
    .auto-style1 {
        text-align: center;
    }
                ...
                <table align="center" class="auto-style1">
                    <tr>
                        <td class="auto-style2">
                            <asp:Label ID="Label1" runat="server" Font-Names="Impact" Font-Size="X-Large" Font-Underline="True" Text="Search For Products "></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <table align="center" class="auto-style3">
                    <tr>
                        <td class="auto-style7" colspan="3">
                            <asp:Label ID="LblTitle" runat="server" Font-Bold="True" Font-Size="X-Large" Text="Products "></asp:Label>
                        </td>
                        <td rowspan="10">
                    ...
                    <tr>
                        <td class="auto-style13">
                            <asp:Label ID="Label4" runat="server" Font-Bold="True" Text="Categorie:"></asp:Label>
                        </td>
                        <td class="auto-style18">
                            <asp:DropDownList ID="ddlCat" runat="server" DataSourceID="SqlDataSource1" DataTextField="CatName" DataValueField="CatNo">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LeaderConStr %>" SelectCommand="SELECT DISTINCT [CatNo], [CatName] FROM [Category]"></asp:SqlDataSource>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="auto-style20">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtProID">*</asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style13">
                    ...
                    <tr>
                        <td class="auto-style13">
                            <asp:Label ID="Avalibile" runat="server" Text="Avalibile Quantity : "></asp:Label>
                        </td>
                        <td class="auto-style18">
                            <asp:TextBox ID="txtAvQty" runat="server"></asp:TextBox>
                        </td>
                        <td class="auto-style20">&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="auto-style19">
                            <asp:FileUpload ID="fup" runat="server" Height="24px" />
                        </td>
                ...
                <%--    <tr>
                        <td class="auto-style22" colspan="3">
                            <asp:UpdateProgress ID="UpdateProgress3" runat="server">
                                <ProgressTemplate>
                                    <asp:Image ID="Image3" runat="server" Height="66px" ImageUrl="~/images/téléchargement.png" Width="82px" />
                                </ProgressTemplate>
                            </asp:UpdateProgress>
                        </td>
                    </tr>--%>
